...
public class KitDumper
{
    private static final Logger logger = LoggerFactory.getLogger(KitDumper.class);
    private static final Logger log = LoggerFactory.getLogger(KitDumper.class);

    private static final Gson gson = new GsonBuilder().setPrettyPrinting().create();

    public static void dump() throws IOException
    {
        File dumpDir = new File(Constants.DUMP_DIR, "kit");
        dumpDir.mkdirs();
